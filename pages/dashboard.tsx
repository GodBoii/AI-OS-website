  ...
  const platforms = [
    {
      ...
      desc: '64-bit installer (v1.2.24)',
      filename: 'Aetheria.AI.Setup.1.2.24.exe',
      path: 'https://github.com/GodBoii/AI-OS-website/releases/download/v1.2.24/Aetheria.AI.Setup.1.2.24.exe',
      available: true,
    },
    {
      name: 'Linux',
          ...
          >
            ...
            <div className="rounded-2xl border border-white/[0.05] bg-white/[0.01] p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-8">
                ...
                <span className="text-[10px] font-mono text-white/30 tracking-widest px-2 py-1 border border-white/10 rounded">v1.2.24</span>
              </div>
