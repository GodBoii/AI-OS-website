    ...
    <>
          ...
          <div className="relative mx-auto max-w-4xl">
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-600/20 rounded-2xl p-8 glass-effect">
              <div className="bg-gray-800 rounded-lg overflow-hidden">
                <img src="/app-home-page.png" alt="AI-OS Desktop Preview" className="w-full h-auto" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="about" className="py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-400 mb-12">The developer behind AI-OS</p>
          ...
          <div className="max-w-3xl mx-auto glass-effect rounded-xl p-8">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 mb-6 max-w-2xl">
                ...
                AI-OS represents my vision for the future of computing where artificial intelligence seamlessly integrates with our daily workflows.
              </p>
